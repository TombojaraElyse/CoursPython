...
class DictionnaireOrdonne:
    """Notre dictionnaire ordonné. L'ordre des données est maintenu et il est peut donc, contrairement aux dictionnaires usuels, être trié ou voir l'ordre de ses données inversés"""
    ...
    def __init__(self, base={}, **donnees):
        ...
        self._valeurs = [] # Liste contenant les valeurs corresponant à nos clés
        ...
        # On recupère les données de 'base'
        for cle in base:
            self[cle] = base[cle]
    ...
    def __repr__(self):
        """Représentation de notre objet. C'est cette chaîne qui sera affichée quand on saisit directement le dictionnaire dans l'interpeteur, ou en utilisant la fonction 'repr' """
    ...
    def __str__(self):
        """Foction appelée quand on souhaite afficher le dictionnaire grâce à la fonction 'print' ou le convertir en chaîne grâce au constructeur 'str'. On redirige sur __repr__ """
    ...
    def __setitem__(self, cle, valeur):
        """ Methode spéciale appelée quand on cherche à modifier une clé présente dans le dictionnaire. Si la clé n'est pas présente, on l'ajoute à la fin du dictionnaire"""
    ...
    def __add__(self, autre_objet):
        ...
        if type(autre_objet) is type(self):
            ...
            # On commence par copier self ans le dictionnaire
            for cle, valeur in self.items():
                nouveau[cle] = valeur
